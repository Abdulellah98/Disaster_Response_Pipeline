...
def clean_data(df):
     ...
     '''
    INPUT
    a merged dataframe dataframe for data cleaning
    ...
    # Remove some values that were 2 and drop `child_alone` column because all the values are equal to 0 
    # to avoid bias and doesn't affect our model
    df = df[df['related'] != 2]
